...
<jsp:useBean id="props" class="props.Posts"></jsp:useBean>
<!DOCTYPE html>
<html>
<html>
<head>
    ...
    <style>
        ...
        header::after
        {
            ...
            background-image: url(https://www.wallpaperflare.com/static/25/375/590/landscape-nature-lake-reflection-wallpaper.jpg);
...
<div id="post-index" class="container" style="display: block;">
    ...
    %>
    <h2 style="text-align: center;"><%=posts.getTitle()%></h2>
    <article>
        <p><%=posts.getDetail()%></p>
    </article>
